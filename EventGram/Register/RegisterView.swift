...
class RegisterView: UIView {
    ...
    func setupRetypePasswordTextField() {
        ...
        retypePasswordTextField.translatesAutoresizingMaskIntoConstraints =
            false
    ...
    func setupClubLabel() {
        clubLabel = UILabel()
        clubLabel.text =
            "Want to register as a club? Please enter the Access Code given to you!"
    ...
    func setupLoginPromptButton() {
        ...
        loginPromptButton.setTitle(
            "Already have an account? Login", for: .normal)
    ...
    func initConstraints() {
        NSLayoutConstraint.activate([
            ...
            nameTextField.topAnchor.constraint(
                equalTo: subtitleLabel.bottomAnchor, constant: 40),
            ...
            universityTextField.topAnchor.constraint(
                equalTo: emailTextField.bottomAnchor, constant: 16),
            universityTextField.leadingAnchor.constraint(
                equalTo: leadingAnchor, constant: 20),
            universityTextField.trailingAnchor.constraint(
                equalTo: trailingAnchor, constant: -20),
            universityTextField.heightAnchor.constraint(equalToConstant: 50),

            passwordTextField.topAnchor.constraint(
                equalTo: universityTextField.bottomAnchor, constant: 16),
            ...
            retypePasswordTextField.topAnchor.constraint(
                equalTo: passwordTextField.bottomAnchor, constant: 16),
            retypePasswordTextField.leadingAnchor.constraint(
                equalTo: leadingAnchor, constant: 20),
            retypePasswordTextField.trailingAnchor.constraint(
                equalTo: trailingAnchor, constant: -20),
            retypePasswordTextField.heightAnchor.constraint(
                equalToConstant: 50),

            clubLabel.topAnchor.constraint(
                equalTo: retypePasswordTextField.bottomAnchor, constant: 16),
            clubLabel.leadingAnchor.constraint(
                equalTo: leadingAnchor, constant: 20),
            clubLabel.trailingAnchor.constraint(
                equalTo: trailingAnchor, constant: -20),
            clubLabel.heightAnchor.constraint(equalToConstant: 50),

            accessCodeTextField.topAnchor.constraint(
                equalTo: clubLabel.bottomAnchor, constant: 16),
            accessCodeTextField.leadingAnchor.constraint(
                equalTo: leadingAnchor, constant: 20),
            accessCodeTextField.trailingAnchor.constraint(
                equalTo: trailingAnchor, constant: -20),
            accessCodeTextField.heightAnchor.constraint(equalToConstant: 50),

            createAccountButton.bottomAnchor.constraint(
                equalTo: loginPromptButton.topAnchor, constant: -8),
            ...
            loginPromptButton.bottomAnchor.constraint(
