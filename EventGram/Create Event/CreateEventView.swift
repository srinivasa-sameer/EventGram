...
class CreateEventView: UIView {
    ...
    func setupDateField() {
        ...
        dateTextField.rightView = UIImageView(
    ...
    func initConstraints() {
        NSLayoutConstraint.activate([
            ...
            eventDescriptionField.topAnchor.constraint(
                equalTo: eventTitleTextField.bottomAnchor, constant: 16),
            eventDescriptionField.leadingAnchor.constraint(
                equalTo: contentView.leadingAnchor, constant: 20),
            eventDescriptionField.trailingAnchor.constraint(
                equalTo: contentView.trailingAnchor, constant: -20),
            eventDescriptionField.heightAnchor.constraint(equalToConstant: 100),

            uploadBannerView.topAnchor.constraint(
                equalTo: eventDescriptionField.bottomAnchor, constant: 16),
            ...
            uploadImageIcon.centerXAnchor.constraint(
                equalTo: uploadBannerView.centerXAnchor),
            uploadImageIcon.topAnchor.constraint(
                equalTo: uploadBannerView.topAnchor, constant: 30),
            uploadImageIcon.widthAnchor.constraint(equalToConstant: 40),
            uploadImageIcon.heightAnchor.constraint(equalToConstant: 40),

            uploadBannerButton.centerXAnchor.constraint(
                equalTo: uploadBannerView.centerXAnchor),
            uploadBannerButton.topAnchor.constraint(
                equalTo: uploadImageIcon.bottomAnchor, constant: 8),

            uploadInfoLabel.centerXAnchor.constraint(
                equalTo: uploadBannerView.centerXAnchor),
            uploadInfoLabel.topAnchor.constraint(
                equalTo: uploadBannerButton.bottomAnchor, constant: 8),
            ...
            createEventButton.topAnchor.constraint(
                equalTo: dateTextField.bottomAnchor, constant: 26),
