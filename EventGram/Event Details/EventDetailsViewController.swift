...
//                        self?.detailsView.bookTicketButton.isEnabled = false
//                        self?.detailsView.bookTicketButton.setTitle("Already Registered", for: .normal)
//                        self?.detailsView.bookTicketButton.backgroundColor = .gray
//                    }
//                }
//            }
//        }
               ...
               let registeredEvents = data["registeredEvents"] as? [String] {
                ...
                if registeredEvents.contains(eventId) {
                    DispatchQueue.main.async {
                        ...
                        self?.detailsView.bookTicketButton.backgroundColor = .red
