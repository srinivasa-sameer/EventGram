...
class EventSuccessView: UIView {
    ...
    func setupInfoLabel() {
        infoLabel = UILabel()
        infoLabel.text =
            "You can always edit your event information\nfrom your personal events page"
    ...
    func setupButtons() {
        ...
        goToEventsButton.backgroundColor = UIColor(
    ...
    func initConstraints() {
        NSLayoutConstraint.activate([
            ...
            successIcon.topAnchor.constraint(
                equalTo: safeAreaLayoutGuide.topAnchor, constant: 100),
            successIcon.widthAnchor.constraint(equalToConstant: 80),
            successIcon.heightAnchor.constraint(equalToConstant: 80),

            successLabel.topAnchor.constraint(
                equalTo: successIcon.bottomAnchor, constant: 24),
            successLabel.centerXAnchor.constraint(equalTo: centerXAnchor),

            eventTitleLabel.topAnchor.constraint(
                equalTo: successLabel.bottomAnchor, constant: 24),
            ...
            eventDateLabel.topAnchor.constraint(
                equalTo: eventTitleLabel.bottomAnchor, constant: 8),
            ...
            infoLabel.bottomAnchor.constraint(
                equalTo: goToEventsButton.topAnchor, constant: -40),

            goToEventsButton.bottomAnchor.constraint(
                equalTo: safeAreaLayoutGuide.bottomAnchor, constant: -20),
            goToEventsButton.leadingAnchor.constraint(
                equalTo: leadingAnchor, constant: 20),
            goToEventsButton.trailingAnchor.constraint(
                equalTo: trailingAnchor, constant: -20),
