...
func createSampleEvents() {
    ...
    let sampleEvents = [
        [
            ...
            "date": Timestamp(
                date: Date().addingTimeInterval(30 * 24 * 60 * 60)),  // 30 days from now
        ...
        [
            ...
            "date": Timestamp(
                date: Date().addingTimeInterval(45 * 24 * 60 * 60)),  // 45 days from now
        ...
        [
            ...
            "date": Timestamp(
                date: Date().addingTimeInterval(60 * 24 * 60 * 60)),  // 60 days from now
            "location": "City Park",
